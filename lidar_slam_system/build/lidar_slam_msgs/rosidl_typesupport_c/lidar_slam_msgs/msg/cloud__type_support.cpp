...
static const _Cloud_type_support_symbol_names_t _Cloud_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lidar_slam_msgs, msg, Cloud)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lidar_slam_msgs, msg, Cloud)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lidar_slam_msgs, msg, Cloud)() {
  return &::lidar_slam_msgs::msg::rosidl_typesupport_c::Cloud_message_type_support_handle;
}

...
static const _Cloud_type_support_symbol_names_t _Cloud_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lidar_slam_msgs, msg, Cloud)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lidar_slam_msgs, msg, Cloud)),
  }
};
...
{
  return &::lidar_slam_msgs::msg::rosidl_typesupport_cpp::Cloud_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lidar_slam_msgs, msg, Cloud)() {
  return get_message_type_support_handle<lidar_slam_msgs::msg::Cloud>();
}

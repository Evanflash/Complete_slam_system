...
#include "lidar_slam_msgs/msg/detail/cloud__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const lidar_slam_msgs::msg::Cloud *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lidar_slam_msgs::msg::Cloud *>(
    untyped_ros_message);
...
{
  return &lidar_slam_msgs::msg::typesupport_fastrtps_cpp::_Cloud__handle;
}

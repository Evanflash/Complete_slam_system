...
#include "lidar_slam_msgs/msg/detail/point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const lidar_slam_msgs::msg::Point & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lidar_slam_msgs::msg::Point & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
...
{
  auto typed_message =
    static_cast<const lidar_slam_msgs::msg::Point *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lidar_slam_msgs::msg::Point *>(
    untyped_ros_message);
...
{
  return &lidar_slam_msgs::msg::typesupport_fastrtps_cpp::_Point__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lidar_slam_msgs, msg, Point)() {
  return &lidar_slam_msgs::msg::typesupport_fastrtps_cpp::_Point__handle;
}
